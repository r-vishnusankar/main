...
const VALID_NAV_IDS: NavItemId[] = ["create", "banners", "gallery", "templates", "content-publish", "help"];

export default function EditorPage() {
  const searchParams = useSearchParams();
  const pathname = usePathname();
  const router = useRouter();
  const [activeNavState, setActiveNavState] = useState<NavItemId>("create");
  ...
  useEffect(() => {
    ...
    if (view && VALID_NAV_IDS.includes(view as NavItemId)) {
      ...
      setLeftSidebarVisible(true); // Always show sidebar in dashboard
    }
          ...
          {activeNav === "create" && (
            ...
            <div className="w-full min-w-0 px-8 py-10">
              ...
              <div className="mb-8 p-6 rounded-xl border border-white/[0.08] card-glass">
                  ...
                  <p className="text-sm text-gray-400 mb-4">Choose a purpose above, edit the prompt below, then click Generate. Or upload an imageâ€”you&apos;ll go straight to the Banner Editor to add prompts per slide.</p>
                  <ImageSourcePanel
              ...
              <div className="mb-8 p-6 rounded-xl border border-white/[0.08] card-glass">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {batchGenerating ? `Generatingâ€¦ ${batchProgress}` : "Generate from list"}
                  </button>
                ...
                <div className="p-6 rounded-xl border border-white/[0.08] card-glass hover:border-white/[0.15] transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-[14px] font-medium text-white">Banner for homepage</p>
            ...
            <div className="w-full min-w-0 px-8 py-10">
              ...
              {/* Two-column editor layout â€” carousel takes 2/3, export panel 1/3 */}
